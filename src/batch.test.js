...
import ExampleGraphQLToolsSchema from '../examples/graphql-tools';
...
describe('examples', () => {
  const schemas = [
    { name: 'graphql', schema: ExampleGraphQLSchema },
    { name: 'graphql-tools', schema: ExampleGraphQLToolsSchema },
  ];
